from transformers.models.longformer.modeling_longformer import LongformerModel, LongformerLMHead, LongformerPreTrainedModel, LongformerMaskedLMOutput
...
class DebertaV1ForMaskedLM(DebertaPreTrainedModel):
